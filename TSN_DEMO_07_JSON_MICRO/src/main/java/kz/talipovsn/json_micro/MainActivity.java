...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://api.github.com/users/proffix4/subscriptions"; // Адрес получения JSON - данных
    ...
    public void onClick(View view) {
        ...
        if (json != null) {
            ...
            textView.append("Подписки proffix4/tsn: " + "\n");
            try {
                JSONArray _newSubs = new JSONArray(json);
                for (int i = 0;i < _newSubs.length(); i++ ) {
                    JSONObject subs = _newSubs.getJSONObject(i);
//                    JSONObject subs1 = subs.getJSONObject("full_name");
                    String subs2 = subs.getString("name");
                    textView.append((i+1) + ") " + subs2 + "\n");
                }
